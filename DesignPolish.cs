...
partial class LumeStudio {
 ...
 void InitializeDesign(){
  Text="Lume Studio · "+ReleaseVersion;windowTitle.Text=Text;Muted=Color.FromArgb(168,174,192);
