...
& $compiler /nologo "/win32manifest:$PSScriptRoot/app.manifest" "/win32icon:$PSScriptRoot/LumeStudio.ico" /target:winexe /platform:x64 /main:LumeStudio /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:System.Web.Extensions.dll "/out:$PSScriptRoot/LumeRGB-Studio-v22.exe" $sources $resourceArgs
