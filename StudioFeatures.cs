...
partial class ThebestRGB {
 ...
 void InitializeFeatures(){
  ...
  tray=new NotifyIcon{Icon=LoadAppIcon(),Text="ThebestRGB",ContextMenuStrip=trayMenu,Visible=true};tray.DoubleClick+=delegate{RestoreWindow();};Resize+=delegate{if(WindowState==FormWindowState.Minimized&&!editorOpen)HideToTray();};FormClosed+=delegate{tray.Visible=false;tray.Dispose();trayMenu.Dispose();};
