...
partial class ThebestRGB {
 ...
 void InitializeWindowChrome(){
  ...
  windowMinimize.Click+=delegate{WindowState=FormWindowState.Minimized;};windowMaximize.Click+=delegate{WindowState=WindowState==FormWindowState.Maximized?FormWindowState.Normal:FormWindowState.Maximized;LayoutWindowChrome();};windowClose.Click+=delegate{if(closeToTray&&!editorOpen)HideToTray();else Close();};
