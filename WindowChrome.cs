...
partial class LumeStudio {
 ...
 void InitializeWindowChrome(){
  ...
  windowTitle=new Label{Text="Lume / Studio 22",ForeColor=Color.FromArgb(205,207,220),Font=new Font("Segoe UI",8),AutoSize=false,TextAlign=ContentAlignment.MiddleLeft};windowChrome.Controls.Add(windowTitle);
