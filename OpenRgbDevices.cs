...
class OpenRgbDevicesForm:Form {
 ...
 public OpenRgbDevicesForm(){
  ...
  close=ThebestRGB.Button("Fechar",Color.FromArgb(151,119,246));close.ForeColor=Color.Black;close.SetBounds(496,358,140,34);close.DialogResult=DialogResult.Cancel;Controls.Add(close);CancelButton=close;
